...
- Replies are delivered to the **last-used main provider** (WhatsApp/Telegram/Discord/Slack/Rocket.Chat/Signal/iMessage/WebChat). If delivery fails, the error is logged and the run is still visible via WebChat/session logs.
